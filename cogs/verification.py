    ...
    async def on_raw_reaction_add(self, payload=None):
        ...
        if payload is not None:
            ...
            if search is not None:
                if payload.message_id == search.message_id:
